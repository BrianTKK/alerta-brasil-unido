          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li><a href="#" className="hover:text-green-400">Monitoramento</a></li>
                <li><a href="#" className="hover:text-green-400">Alertas</a></li>
                <li><a href="#" className="hover:text-green-400">Prevenção</a></li>
                <li><a href="#" className="hover:text-green-400">Educação</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><a href="#" className="hover:text-green-400">Pontos de Apoio</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li>contato@brasilunido.gov.br</li>
                <li>0800 123 4567</li>
